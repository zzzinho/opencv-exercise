...
void MatOp1()
{
    ...
    Mat img2(480, 640, CV_8UC1);    // unsigned char , channel 1 (graysclae)
    Mat img3(480, 640, CV_8UC3);    // unsigned char, channel 3 (true color)
    Mat img4(Size(640,480), CV_8UC3);   // unsigned char, Size(640,480)
